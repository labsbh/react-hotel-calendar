...
var Month = forwardRef(function (_a, ref) {
    ...
    var getWeekDayNames = useCallback(function () {
        return Array.from(Array(7).keys()).map(function (day) {
            var _a, _b;
            return (jsx(WeekDayName, __assign({ className: "rhc-weekday-name" }, { children: (_a = locale.localize) === null || _a === void 0 ? void 0 : _a.day((day + (((_b = locale.options) === null || _b === void 0 ? void 0 : _b.weekStartsOn) || 0)) % 7, {
                    width: 'abbreviated',
                }) }), "day-name-" + day));
        });
    }, [locale]);
    ...
    return (jsxs(MonthTable, __assign({ first: first, ref: ref }, { children: [jsxs("thead", { children: [jsxs(Caption, { children: [jsx("th", { children: showPrevious && (jsx(NavButton, __assign({ onClick: goToPreviousMonth, className: "rhc-previous-btn" }, { children: "<" }), void 0)) }, void 0), jsx(MonthName, __assign({ colSpan: 5, className: "rhc-month-name" }, { children: getMonthName(date) }), void 0), jsx("th", { children: showNext && jsx(NavButton, __assign({ onClick: goToNextMonth, className: "rhc-next-btn" }, { children: ">" }), void 0) }, void 0)] }, void 0), jsx(WeekDays, __assign({ className: "rhc-weekdays" }, { children: getWeekDayNames() }), void 0)] }, void 0), jsx("tbody", { children: date &&
...
var Calendar = function () {
    var _a = useState(false), laptop = _a[0], setLaptop = _a[1];
    var secondMonthRef = useIntersectionObserverRef(function (entries) {
        if (entries && entries[0]) {
            setLaptop(entries[0].isIntersecting);
        }
    })[0];
    var _b = useContext(OptionCtx), startDate = _b.startDate, endDate = _b.endDate, moveBothMonths = _b.moveBothMonths;
    var _c = useState(startDate ? startDate : new Date()), firstMonth = _c[0], setFirstMonth = _c[1];
    var _d = useState(addMonths(startDate ? startDate : new Date(), 1)), secondMonth = _d[0], setSecondMonth = _d[1];
    var _e = useState(false), isRender = _e[0], setIsRender = _e[1];
    useEffect(function () {
